...
func (*Controller) Create(ctx context.Context, req *v1.CreateReq) (res *v1.CreateResp, err error) {
	id, err := words.Create(ctx)
	if err != nil {
		return nil, err
	}
	return &v1.CreateResp{Id: uint32(id)}, nil
}

func (*Controller) Get(ctx context.Context, req *v1.GetReq) (res *v1.GetResp, err error) {
