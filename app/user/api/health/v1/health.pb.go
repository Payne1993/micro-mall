...
func (x *HealthRes) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_health_v1_health_proto_goTypes = []any{
	(*HealthReq)(nil), // 0: health.v1.HealthReq
	(*HealthRes)(nil), // 1: health.v1.HealthRes
}
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: health.v1.Health.Health:input_type -> health.v1.HealthReq
	1, // 1: health.v1.Health.Health:output_type -> health.v1.HealthRes
