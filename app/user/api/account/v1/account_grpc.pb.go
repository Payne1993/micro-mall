...
func (c *accountClient) UserRegister(ctx context.Context, in *UserRegisterReq, opts ...grpc.CallOption) (*UserRegisterResp, error) {
...
func (UnimplementedAccountServer) UserRegister(context.Context, *UserRegisterReq) (*UserRegisterResp, error) {
