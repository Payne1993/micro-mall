...
func (x *UserRegisterResp) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
const file_account_v1_account_proto_rawDesc = "" +
	...
	"\vUserInfoRes\x12#\n" +
	"\x04user\x18\x01 \x01(\v2\x0f.pbentity.UsersR\x04user2\xd9\x01\n" +
	"\aAccount\x12K\n" +
...
var file_account_v1_account_proto_goTypes = []any{
	...
	(*UserRegisterResp)(nil), // 1: account.v1.UserRegisterResp
...
var file_account_v1_account_proto_depIdxs = []int32{
	...
	1, // 4: account.v1.Account.UserRegister:output_type -> account.v1.UserRegisterResp
